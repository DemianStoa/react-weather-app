...
var useAsyncPaginateBase = (params, deps = []) => {
  ...
  const isInitRef = (0, import_react15.useRef)(true);
  const paramsRef = (0, import_react15.useRef)(params);
  paramsRef.current = params;
  const setStateId = (0, import_react15.useState)(0)[1];
  const optionsCacheRef = useLazyRef(() => getInitialOptionsCache(params));
  const callRequestOptions = (0, import_react15.useCallback)((caller) => {
    requestOptions(
      caller,
      paramsRef,
      optionsCacheRef,
  ...
  const handleScrolledToBottom = (0, import_react15.useCallback)(() => {
    const currentInputValue = paramsRef.current.inputValue;
...
var useAsyncPaginate = (params, deps = []) => {
  ...
  const [inputValueState, setInputValue] = (0, import_react14.useState)(
    defaultInputValueParam || ""
  );
  const [menuIsOpenState, setMenuIsOpen] = (0, import_react14.useState)(
  ...
  const onInputChange = (0, import_react14.useCallback)((nextInputValue, actionMeta) => {
    if (onInputChangeParam) {
      onInputChangeParam(nextInputValue, actionMeta);
    }
    setInputValue(nextInputValue);
  }, [onInputChangeParam]);
  const onMenuClose = (0, import_react14.useCallback)(() => {
    if (onMenuCloseParam) {
      onMenuCloseParam();
    }
    setMenuIsOpen(false);
  }, [onMenuCloseParam]);
  const onMenuOpen = (0, import_react14.useCallback)(() => {
    if (onMenuOpenParam) {
      onMenuOpenParam();
    }
    setMenuIsOpen(true);
...
function wrapMenuList(MenuList22) {
  function WrappedMenuList(props) {
    ...
    const checkTimeoutRef = (0, import_react17.useRef)();
    const menuListRef = (0, import_react17.useRef)(null);
    const shouldHandle = (0, import_react17.useCallback)(() => {
    ...
    const checkAndHandle = (0, import_react17.useCallback)(() => {
      if (shouldHandle()) {
    ...
    const setCheckAndHandleTimeout = (0, import_react17.useCallback)(() => {
      checkAndHandle();
...
var useComponents = (components2) => (0, import_react16.useMemo)(() => ({
  MenuList: MenuList3,
  ...components2
}), [components2]);
